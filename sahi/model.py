    ...
    def load_model(self):
        ...
        if self.category_mapping is None:
            try:  # try to parse category names from metadata
                ...
                self.category_names = category_names  # 可固定值
        ...
        for ind in range(len(boxes)):
            ...
            if masks is None:
                ...
                if get_bbox_from_bool_mask(mask) is None:
                    ...
                    bbox = None  # get_bbox_from_bool_mask(mask):[xmin, ymin, xmax, ymax] or generate later
            ...
            object_prediction_list.append(object_prediction)  # 每次存储一个数据对象
